...
this.hystoken = function(obj_or_address) {
			if(typeof obj_or_address == "undefined") obj_or_address=parent.options.contracts["StromDAO-BO.sol:HySToken"];
			
			var p1 = new Promise(function(resolve, reject) { 
				var instance=parent._objInstance(obj_or_address,'StromDAO-BO.sol:HySToken');			
				instance.test = {};				
				...
				instance.maxSupply=function() {					
					var p2 = new Promise(function(resolve2, reject2) { 							
							instance.obj.maxSupply().then(function(o) {														
								 resolve2(o[0].toString()*1);									
							});									
					});
					return p2;
